...
function createCards(events, section) {
      ...
      <article class="card bg-dark text-light cards-fix">
        ...
        <div class="card-body d-flex flex-column justify-content-between">
          ...
          <div class="d-flex justify-content-between align-items-center gap-3">
            ...
            <a class="btn btn-primary" href="/pages/details.html?id=${newcard._id}">Go to event</a>
          </div>
        </div>
      </article>
    `; // ? = marca comienza de la querystring
  }
  ...
  if (events.length === 0) {
    ...
    messageSection.className = "container-fluid d-flex flex-wrap justify-content-center align-items-center";
    messageSection.innerHTML += `
      <img src="./assets/img/error/404.jpeg" alt="HTTP Cats Error 404">
    `;
