...
// // CATEGORYS - CHECKBOX's
// function createCheckbox(events, div) {
//   let category = events => events.category
//   let categorys = new Set(events.map(category))
//   categorys.forEach(div => {
//     div.className = "container-fluid d-flex flex-wrap justify-content-center align-items-center gap-4"
//     div.innerHTML += `
//     <div class="form-check">
//       <label class="form-check-label text-light" for="${div}"><input class="form-check-input" type="checkbox" role="switch" value="${div}" id="${div}">${div}</label>
//     </div>
//     `
...
// CARDS - ARTICLE'S
function createCard(events, section) {
  for (let newcard of events) {
    let section = document.createElement("section")
    section.className = "container-fluid d-flex flex-wrap justify-content-center align-items-center gap-4 cards-fix"
    section.innerHTML += `
